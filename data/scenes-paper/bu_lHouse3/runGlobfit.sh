...
export WORKSPACE="/home/bontius/workspace"
$WORKSPACE/globOpt/build/Release/bin/toGlobFit --planes --prims segments.csv --cloud cloud.ply -a points_segments.csv --scale $scale
