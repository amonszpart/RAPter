...
../../globOptVis --show3D --scale $scale --pop-limit $poplimit -p primitives_it26.bonmin.csv -a points_primitives_it25.csv --title "GlobOpt" $visdefparam --paral-colours --no-rel &
