...
python ../normal_distr.py cloudRGBNormal_it69_reProj_noUnass_noPrim.ply ndistrIt69_accum.svg "Euler - Iteration 69 - Accum" --gaussFile2 ../bu_eulerCut/cloudRGBNormal_it45_reProj_noUnass_noPrim.ply 
