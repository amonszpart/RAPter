#ifndef __RAPTER_POINTPRIMITIVE_H__
...
namespace rapter
{
    ...
    class PointPrimitive : public ::rapter::Primitive<3,6>
    {
        ...
        public:
            ...
            using ::rapter::Primitive<Dim>::Primitive;
#else
            ...
            //! \brief ::rapter::Primitive<Dim>::operator() are inherited convenience getters from parent class. \todo Use explicit operator VectorType() instead.
...
#endif // __RAPTER_POINTPRIMITIVE_H__
