        ...
        : public PrimitiveShapeVisitor
{
    public:
        ...
        ScorePrimitiveShapeVisitorImpl( float distThresh, float normalThresh )
            : m_pointComp(distThresh, normalThresh)
        {}

        void           SetOctree( const OctreeT &oct ) { m_oct = &oct; }
        OctreeT const& GetOctree() const { return *m_oct; }
        ...
        : public PrimitiveShapeVisitorShell< ScorePrimitiveShapeVisitorImpl< PointCompT, OctreeT > >
{
    public:
        ScorePrimitiveShapeVisitor( float distThresh, float normalThresh )
            : PrimitiveShapeVisitorShell<ScorePrimitiveShapeVisitorImpl<PointCompT, OctreeT> >(distThresh, normalThresh)
        {}
};
