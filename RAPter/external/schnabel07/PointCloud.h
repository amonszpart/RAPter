...
struct DLL_LINKAGE Point {
        ...
        explicit operator GfxTL::VectorXD< 3, float > &()
        {
            return *reinterpret_cast< GfxTL::Vector3Df * >(const_cast<float*>(pos.getValue())); //changed by Aron 24042015
        }
        explicit operator const GfxTL::VectorXD< 3, float > &() const
        {
            return *reinterpret_cast< const GfxTL::Vector3Df * >(const_cast<float*>(pos.getValue()));
        }
};
