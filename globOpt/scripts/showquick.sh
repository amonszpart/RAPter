...
../globOptVis --paral-colours --perfect-angle 0.001 --show$flag3D --scale 0.02 --pop-limit 3 -p $prims -a $assignments --title "GlobOpt - $iteration iteration output" --angle-gens 60,90 --use-tags --no-clusters --statuses -1,1 --no-pop --dir-colours --no-scale --bg-colour .9,.9,.9 --no-rel &
