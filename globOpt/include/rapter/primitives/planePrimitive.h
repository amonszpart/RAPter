#ifndef __RAPTER_PLANEPRIMITIVE_H__
#define __RAPTER_PLANEPRIMITIVE_H__

#include <Eigen/Dense>
#include "rapter/optimization/energyFunctors.h"
#include "rapter/primitives/primitive.h"
#include "rapter/processing/util.hpp" // pca, getPopulationOf()
...
namespace rapter
{
    ...
    class PlanePrimitive : public ::rapter::Primitive<3,6>
    {
            typedef ::rapter::Primitive<3,6> ParentT;
...
#if 0
#ifndef __RAPTER_INC_PLANEPRIMITIVE_HPP__
#define __RAPTER_INC_PLANEPRIMITIVE_HPP__
namespace rapter
{
...
#endif // __RAPTER_INC_PLANEPRIMITIVE_HPP__

#endif

#endif // __RAPTER_PLANEPRIMITIVE_H__
