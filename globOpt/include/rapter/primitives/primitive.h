...
namespace rapter
{
    ...
    class Primitive : public ::rapter::Taggable<_Scalar>
    {
        public:
            EIGEN_MAKE_ALIGNED_OPERATOR_NEW

            typedef ::rapter::Taggable<_Scalar> TaggableT;
            typedef TaggableT                    ParentT;
            enum { EmbedSpaceDim = _EmbedSpaceDim };
#if 0
            enum STATUS_VALUES { ACTIVE = 1 //!< Used to show, that this primitive is active. Also used as starting point in \ref rapter::Solver.
            ...
            {
                static const char ACTIVE  = 1; //!< Used to show, that this primitive is active. Also used as starting point in \ref rapter::Solver.
