#ifndef __RAPTER_LINEPRIMITIVE_H__
#define __RAPTER_LINEPRIMITIVE_H__

#include <fstream>
#include <memory> // shared_ptr

#include <Eigen/Dense>
#include "rapter/optimization/energyFunctors.h"   // pointToFiniteLineDistanceFunctor
#include "rapter/primitives/primitive.h"          // inherit
#include "rapter/processing/util.hpp"             // getPopulationOf()
...
namespace rapter
{
    ...
    class LinePrimitive : public ::rapter::Primitive<2,6>
    {
            typedef ::rapter::Primitive<2,6>   ParentT;
        public:
...
#endif // __RAPTER_LINEPRIMITIVE_H__
