#ifndef RAPTER_ENERGYFUNCTORS_H__
...
namespace rapter
{
    ...
    struct MyPrimitivePrimitiveAngleFunctor
    {
        ...
        {
            // angle
            Scalar angle = rapter::angleInRad( p1.dir(), p2.dir() );
            // check nan
...
#if 1
    /*! \brief Used to setup spatially smooth pairwise cost in \ref rapter::problemSetup::formulate().
     * \tparam _PrimitiveCompFunctor Concept: \ref rapter::MyFinitePrimitiveToFinitePrimitiveCompatFunctor
     */
...
#endif // RAPTER_ENERGYFUNCTORS_H__
