...
namespace GF2
{
    ...
    class PlanePrimitive : public ::GF2::Primitive<6>, public ::GF2::Taggable
    {
        ...
        public:
            ...
            inline Eigen::Matrix<Scalar,3,1> normal() const { return _coeffs.segment<3>(3); } //TODO: don't replicate
