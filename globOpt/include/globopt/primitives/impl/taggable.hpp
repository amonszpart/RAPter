#ifndef __GO_TAGGABLE_HPP__
#define __GO_TAGGABLE_HPP__
...
namespace globopt
{
    ...
    template <typename _Scalar>
    inline GF2::GidT
    Taggable<_Scalar>::getTag( GF2::GidT key ) const
    {
        typename std::map<GF2::GidT,GF2::GidT>::const_iterator it = _longValuedTags.find( key );
    ...
    {
        return getTag( static_cast<GF2::GidT>(key) );
    }
